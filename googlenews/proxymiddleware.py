...
class RandomProxyMiddleware(object):
    ...
    def __init__(self):
        ...
        self.proxies = [l.strip() for l in open('proxy.list').readlines()]
    ...
    def process_request(self, request, spider):
        ...
        # if self.proxies and not request.meta.get("proxy") and request.url not in spider.start_urls and 'google' not in request.url:
